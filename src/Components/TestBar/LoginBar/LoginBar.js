          ...
          <div className={classes.paper}>
            ...
            <form action="" className="ms-4">
                ...
                <div className="mt-5 text-center">
                    ...
                    <div class="d-grid gap-2 col-12 mx-auto ms-3">
                  <button class="btn btn-primary btnColor" onClick={() => handleOpenSign(true)} onClose={handleCloseSign} type="button">Sign up with Email</button>
                </div>
                </div>
            </form>
                </Grid>
        ...
        <Fade in={openSign}>
          <div className={classes.paper}>
            <Grid container>
                ...
                <Grid item lg={6}>
                    <CancelIcon className={classes.cancelBtn} onClick={handleCloseSign}/>
